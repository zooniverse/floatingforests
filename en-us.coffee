module.exports =
  site:
    title: 'Kelp Hunters'
    summary: 'Discover Floating Forests in the Sea'
    description: "Marine biologists are trying to understand how forests of kelp grow and change over time. They need your help to find these forests in pictures from space!"
